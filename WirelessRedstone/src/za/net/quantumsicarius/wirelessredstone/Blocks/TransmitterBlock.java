...
public class TransmitterBlock extends GenericCubeCustomBlock {
	public TransmitterBlock(Plugin plugin, Texture transmitter_Texture_off, String s) {
		super(plugin, s, true, new GenericCubeBlockDesign(plugin, transmitter_Texture_off, new int[] { 1, 0, 0, 0, 0, 1 }));
	}
}
